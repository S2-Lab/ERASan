...
clang erasanOptAnalysis.o -o erasan-debloating -L$LIBRARY_DIR -L$DLIBRARY_DIR -lstd-bc021c2817d56996 -lpthread -ldl -lm -fsanitize=address -lssl -lcrypto $RLIBS $DRLIBS $DRLIBS $RLIBS
