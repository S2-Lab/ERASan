...
public:
    ...
    ///Compute offset of an Extract/Insert Instruction expression
    bool computeExtInsOffest(const User* V, LocationSet& ls);
    ...
    /* Handling ExtractValueInst for Rust Program*/
    void visitExtractValueInst(ExtractValueInst  &EVI);

    void visitBranchInst(BranchInst &I);
    void visitSwitchInst(SwitchInst &I);

    /* Handling InsertValueInst for Rust Program*/
    ...
    /// Add ExtractValue Edge
    inline ExtractValPE* addExtractValPE(NodeID src, NodeID dst, const LocationSet& ls){
        ExtractValPE* edge = pag->addExtractValPE(src, dst, ls);
        setCurrentBBAndValueForPAGEdge(edge);
        return edge;
    }

    /// Add InsertValue Edge
    inline InsertValPE* addInsertValPE(NodeID src, NodeID dst, const LocationSet& ls){
        InsertValPE* edge = pag->addInsertValPE(src, dst, ls);
        setCurrentBBAndValueForPAGEdge(edge);
        return edge;
    }
