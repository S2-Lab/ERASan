...
protected:
    ...
    ConstraintEdge::ConstraintEdgeSetTy InsertValCGEdgeSet;
    ConstraintEdge::ConstraintEdgeSetTy ExtractValCGEdgeSet;
...
public:
    ...
    inline bool hasEdge(ConstraintNode* src, ConstraintNode* dst, ConstraintEdge::ConstraintEdgeK kind)
    {
        ...
        else if(kind == ConstraintEdge::InsertVal)
            return InsertValCGEdgeSet.find(&edge) != InsertValCGEdgeSet.end();
        else if(kind == ConstraintEdge::ExtractVal)
            return ExtractValCGEdgeSet.find(&edge) != ExtractValCGEdgeSet.end();
        else
    ...
    InsertValCGEdge* addInsertValCGEdge(NodeID src, NodeID dst, const LocationSet& ls);
    ExtractValCGEdge* addExtractValCGEdge(NodeID src, NodeID dst, const LocationSet& ls);
    //@}
