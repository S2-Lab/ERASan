...
public:
    ...
    {
        Addr, Copy, Store, Load, NormalGep, VariantGep, InsertVal, ExtractVal
    };
private:
    EdgeID edgeId;
public:
    ...
    static inline bool classof(const GenericConsEdgeTy *edge)
    {
        return edge->getEdgeKind() == Addr ||
               ...
               edge->getEdgeKind() == InsertVal ||
               edge->getEdgeKind() == ExtractVal;
    }
 ...
 * InsertVal edge
 */
class InsertValCGEdge : public ConstraintEdge
{
private:
    InsertValCGEdge();                      ///< place holder
    InsertValCGEdge(const InsertValCGEdge &);  ///< place holder
    void operator=(const InsertValCGEdge &); ///< place holder
...
public:
    /// Methods for support type inquiry through isa, cast, and dyn_cast:
    //@{
    static inline bool classof(const InsertValCGEdge *)
    {
        return true;
    }
    ...
    static inline bool classof(const ConstraintEdge *edge)
    {
        return edge->getEdgeKind() == InsertVal;
    }
    static inline bool classof(const GenericConsEdgeTy *edge)
    {
        return edge->getEdgeKind() == InsertVal;
    ...
    /// Constructor
    InsertValCGEdge(ConstraintNode* s, ConstraintNode* d, const LocationSet& l, EdgeID id)
            : ConstraintEdge(s,d,InsertVal,id), ls(l)
    {}
 ...
 * ExtractVal edge
 */
class ExtractValCGEdge : public ConstraintEdge
{
private:
    ExtractValCGEdge();                      ///< place holder
    ExtractValCGEdge(const ExtractValCGEdge &);  ///< place holder
    void operator=(const ExtractValCGEdge &); ///< place holder
...
public:
    /// Methods for support type inquiry through isa, cast, and dyn_cast:
    //@{
    static inline bool classof(const ExtractValCGEdge *)
    {
        return true;
    }
    ...
    static inline bool classof(const ConstraintEdge *edge)
    {
        return edge->getEdgeKind() == ExtractVal;
    }
    static inline bool classof(const GenericConsEdgeTy *edge)
    {
        return edge->getEdgeKind() == ExtractVal;
    ...
    /// Constructor
    ExtractValCGEdge(ConstraintNode* s, ConstraintNode* d, const LocationSet& l, EdgeID id)
            : ConstraintEdge(s,d,ExtractVal,id), ls(l)
    {}
